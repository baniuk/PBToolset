...
/// external methods defined in GTEST_ADDONS.h. Must be extern to avoid linking problems (only because all tests are in one exe)
extern void C_Point_CMP_DOUBLE(const C_Point, const C_Point);
extern void C_Point_CMP(const C_Point, const C_Point);
